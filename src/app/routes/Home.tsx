    ...
    <main className="bg-paper min-h-screen text-ink overflow-x-hidden">
      ...
      <section className="bg-gradient-to-br from-[#FDFBF8] via-[#FAF4ED] to-[#EAD8BE]/30 border-b border-[#ECE6DF] relative py-12 md:py-20">
        <div className="w-[min(calc(100%-24px),1440px)] mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="font-serif text-[42px] sm:text-[54px] md:text-[62px] leading-[1.05] tracking-tight text-[#111]">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link 
                to="/exclusive" 
                className="bg-[#111] text-white px-8 py-3.5 text-[10.5px] tracking-[0.2em] uppercase font-bold hover:bg-black transition-all duration-300 shadow-md rounded-[3px]"
              >
                {lang === "zh" ? "立即選購限定套裝" : "Shop Exclusive Sets"}
              </Link>
              <Link 
                to="/shop" 
                className="border border-[#111] bg-transparent text-[#111] px-8 py-3.5 text-[10.5px] tracking-[0.2em] uppercase font-bold hover:bg-[#111] hover:text-white transition-all duration-300 rounded-[3px]"
              >
              ...
              <div className="p-4 bg-[#FBF6F0] mt-3 rounded-[3px] border border-[#F2ECE4]">
                ...
                <div className="space-y-3 mt-2 text-[12px] text-[#3A3734]">
                  <div className="flex items-start gap-2 border-b border-[#ECE6DF] pb-2">
                    ...
                    <div>
                      <p className="font-semibold text-black">{lang === "zh" ? "滿 HK$2,000 即贈 6 件療敏禮品" : "Spend HK$2,000, get 6-pc Deluxe Set"}</p>
                  ...
                  <div className="flex items-start gap-2">
                    <span className="text-[#825F59] font-bold">●</span>
                    <div>
                      <p className="font-semibold text-black">{lang === "zh" ? "滿 HK$3,000 即贈 10 件療敏禮品" : "Spend HK$3,000, get 10-pc Deluxe Set"}</p>
        ...
        <div className="relative z-10 w-[min(calc(100%-24px),1440px)] mx-auto pb-12 md:pb-20 text-white">
          <div className="max-w-[600px] space-y-4">
            ...
            <div className="pt-2">
              <Link 
                to="/shop" 
                className="inline-flex border border-white text-white px-9 h-[48px] items-center text-[10px] tracking-[0.2em] uppercase font-bold hover:bg-white hover:text-black transition-all duration-300 rounded-[2px]"
              >
      ...
      <section className="border-b border-[#ECE6DF]">
        ...
        <div className="grid md:grid-cols-2">
          <div className="aspect-[4/5] md:aspect-auto h-[50vh] md:h-[90vh] overflow-hidden relative">
            <img 
              src="https://cs12skincare.com.hk/wp-content/uploads/2026/03/cs-12-253-E-720x1080.jpg" 
              alt="CS12 Miracle Mask"
              className="w-full h-full object-cover hover:scale-102 transition duration-[1.5s]"
              loading="lazy"
            />
          ...
          <div className="flex items-center bg-white p-8 sm:p-12 md:p-24">
            <div className="max-w-[480px] space-y-6">
              ...
              <h3 className="font-serif text-[38px] sm:text-[46px] leading-[1.1] text-black">
              ...
              <div className="pt-3">
                <Link 
                  ...
                  className="inline-flex text-[11px] tracking-[0.18em] uppercase font-bold border-b border-black pb-1 hover:text-[#825F59] hover:border-[#825F59] transition duration-200"
                >
        ...
        <div className="grid md:grid-cols-2 bg-[#FBF6F0]">
          ...
          <div className="aspect-[4/5] md:aspect-auto h-[50vh] md:h-[90vh] overflow-hidden order-1 md:order-2">
            <img 
      ...
      <section id="about-section" className="py-20 md:py-28 bg-[#FDFBF8] text-center border-b border-[#ECE6DF]">
        <div className="w-[min(calc(100%-24px),960px)] mx-auto space-y-6">
          ...
          <h2 className="font-serif text-[38px] sm:text-[48px] md:text-[54px] leading-[1.1] font-light text-black tracking-tight">
          ...
          <div className="pt-6">
            <Link 
              to="/shop" 
              className="inline-flex bg-[#111] text-white px-9 py-3.5 text-[10px] tracking-[0.2em] uppercase font-bold hover:bg-black transition rounded-[2px]"
            >
        ...
        <div className="w-[min(calc(100%-24px),1440px)] mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            ...
            <Link to="/shop?series=CalmEX" className="group block space-y-4">
              ...
              <div>
                <h4 className="font-serif text-[22px] text-black">#CalmEX</h4>
            ...
            <Link to="/shop?series=SoCalm" className="group block space-y-4">
              ...
              <div>
                <h4 className="font-serif text-[22px] text-black">#SoCalm</h4>
            ...
            <Link to="/shop?series=CellRevEX" className="group block space-y-4">
              ...
              <div>
                <h4 className="font-serif text-[22px] text-black">#CellRevEX</h4>
            ...
            <Link to="/shop?cat=防曬" className="group block space-y-4">
              ...
              <div>
                <h4 className="font-serif text-[22px] text-black">{lang === "zh" ? "防曬護理" : "Sun Care"}</h4>
      ...
      <section className="w-[min(calc(100%-24px),1440px)] mx-auto py-20 md:py-24">
        <div className="flex justify-between items-end mb-12">
          ...
          <Link 
            to="/exclusive" 
            className="text-[11px] tracking-[0.18em] uppercase font-bold border-b border-black pb-1 hover:text-[#825F59] hover:border-[#825F59] transition"
          >
      ...
      <section className="bg-gradient-to-br from-[#211C19] to-[#111111] text-[#FDFBF8] py-20 md:py-28">
        <div className="w-[min(calc(100%-24px),1440px)] mx-auto space-y-12">
          <div className="text-center md:text-left space-y-3">
            ...
            <p className="text-[#BBB5AD] text-[13px] sm:text-[14px] max-w-[500px]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {testimonials.map((t) => {
              ...
              return (
                <div 
                  key={t.name} 
                  className="bg-white/[0.03] border border-white/10 p-5 rounded-[4px] flex flex-col justify-between hover:bg-white/[0.05] hover:border-white/20 transition-all duration-300"
                >
                  <div className="space-y-4">
                    ...
                    <div 
                      ...
                      className="aspect-[4/3] rounded-[2px] overflow-hidden bg-black/40 border border-white/5 cursor-pointer relative group"
                    >
                      <img 
                        src={t.image} 
                        alt={t.name} 
                      ...
                      <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 flex items-center justify-center transition duration-300">
                        <span className="text-[10px] bg-white text-black font-semibold tracking-wider uppercase px-3 py-1.5 rounded-[2px] shadow-lg">
                          {lang === "zh" ? "點擊放大" : "Zoom In"}
                        </span>
                      </div>
                    </div>

                    <div className="flex gap-1 text-[#D8C6A6]">
                      {[...Array(5)].map((_, i) => <Star key={i} size={13} fill="currentColor" className="stroke-none" />)}
                    </div>

                    <p className="text-[#EAD8BE] font-serif text-[18px] tracking-wide mt-2">{t.name}</p>
                    <p className="text-[#BBB5AD] text-[12px] leading-relaxed line-clamp-5 hover:line-clamp-none transition-all duration-300">
                      &ldquo;{reviewText}&rdquo;
                    </p>
                  </div>

                  <div className="border-t border-white/10 pt-4 mt-4">
                    <span className="text-[10px] uppercase tracking-[0.15em] text-[#8F8881] block font-semibold">
                      {lang === "zh" ? "使用產品" : "Product Used"}
                    </span>
                    <span className="text-[11.5px] text-[#D8C6A6] mt-1 block font-medium">
                      {productName}
                    </span>
                  </div>
                </div>
      ...
      <section id="sensitive-skin-tips" className="py-20 md:py-24 bg-[#FBF6F0] border-b border-[#ECE6DF]">
        <div className="w-[min(calc(100%-24px),1100px)] mx-auto grid md:grid-cols-[1fr_1.3fr] gap-12 items-center">
          ...
          <div className="space-y-5 text-center md:text-left">
            ...
            <h2 className="font-serif text-[36px] sm:text-[46px] leading-[1.1] text-black">
            ...
            <div className="pt-2">
              <Link 
                to="/shop?skin=敏感肌" 
                className="bg-[#111] hover:bg-black text-white text-[11px] font-bold tracking-[0.18em] uppercase px-7 py-3 inline-flex rounded-[2px] transition duration-300"
              >
            ...
            {skinTips.map((tip, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className="font-serif text-[16px] sm:text-[18px] font-semibold text-black tracking-wide">
                      {title}
                    </span>
      ...
      <section className="bg-white py-16 md:py-24 border-b border-[#ECE6DF]">
        <div className="w-[min(calc(100%-24px),1440px)] mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 md:pr-12">
            <h3 className="font-serif text-[32px] sm:text-[42px] leading-tight text-black">
            ...
            {newsletterSuccess ? (
              <div className="bg-[#FAF3E9] border border-[#EAD8BE] p-6 rounded-[3px] space-y-2 text-center md:text-left">
                ...
                <h4 className="font-serif text-[18px] text-black font-semibold">{lang === "zh" ? "訂閱成功！" : "Successfully Subscribed!"}</h4>
              ...
              <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                <div className="flex border border-[#111] rounded-[3px] overflow-hidden focus-within:ring-1 focus-within:ring-black">
                  <input
                    type="email"
                    required
                  ...
                  <button 
                    type="submit" 
                    className="bg-[#111] text-white px-6 text-[11px] tracking-[0.18em] uppercase font-bold hover:bg-black transition duration-200"
                  >
      ...
      <section className="w-[min(calc(100%-24px),1440px)] mx-auto py-16 grid md:grid-cols-3 gap-6 sm:gap-8">
        <div className="bg-white border border-[#ECE6DF] p-8 text-center rounded-[3px] shadow-sm flex flex-col justify-between h-full">
          <div>
            ...
            <h4 className="font-serif text-[22px] text-black font-semibold">
          ...
          <div className="pt-4">
            <Link to="/shop" className="text-[10px] tracking-[0.16em] uppercase font-bold text-black border-b border-black pb-0.5 hover:text-[#825F59] hover:border-[#825F59] transition">
              {lang === "zh" ? "立即選購" : "Shop Now"}
            </Link>
          </div>
        </div>
        ...
        <div className="bg-[#111] text-[#FDFBF8] border border-[#111] p-8 text-center rounded-[3px] shadow-md flex flex-col justify-between h-full">
          <div>
            ...
            <p className="text-[12px] text-[#BBB5AD] mt-2.5 leading-relaxed max-w-[28ch] mx-auto">
      ...
      {lightboxImage && (
        ...
        >
          ...
          >
            ...
            <div className="overflow-hidden bg-black/20 rounded-[2px]">
              <img 
                src={lightboxImage} 
      ...
      {showPromoPopup && (
        ...
        >
          ...
          >
            ...
            <button 
              onClick={() => handleDismissPopup(false)}
              className="absolute -top-3 -right-3 bg-[#111] text-white w-8 h-8 rounded-full flex items-center justify-center hover:bg-black transition duration-200 border-2 border-[#FDFBF8] shadow-md z-30"
            ...
            <div className="space-y-4">
              ...
              <div className="text-center space-y-2 px-2">
                ...
                <div className="pt-2">
                  <Link 
                    to="/exclusive"
                    onClick={() => handleDismissPopup(false)}
                    className="w-full bg-[#111] text-white py-2.5 text-[11px] tracking-[0.18em] uppercase font-bold hover:bg-black transition duration-200 block text-center rounded-[3px] shadow"
                  >
              ...
              <div className="flex items-center justify-center gap-2 border-t border-[#ECE6DF] pt-3 mt-2 text-[11px] text-[#8F8881]">
                <input 
                  ...
                  className="w-3.5 h-3.5 border-[#ECE6DF] rounded focus:ring-0 text-[#111] cursor-pointer"
                />
