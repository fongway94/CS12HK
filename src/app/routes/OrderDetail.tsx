...
export function OrderDetailPage() {
  ...
  const statusConfig: Record<string, { label_zh: string; label_en: string; icon: any; color: string }> = {
    ...
    delivered: { label_zh: "已妥投", label_en: "Delivered", icon: Package, color: "text-[#111] bg-[#111] text-white border-[#111]" },
        ...
        <div className="p-6 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-[#FBF6F0] border border-[#ECE6DF] p-6 sticky top-[100px]">
              ...
              {order.giftTier && (
                <div className="mt-4 pt-4 border-t border-[#ECE6DF] bg-[#111] text-white p-3 text-[11px] rounded">
            ...
            {[
              ...
              return (
                <div key={step.key} className="relative pl-14 pb-8 flex items-start">
                  <div className={`absolute left-6 top-1 w-3 h-3 rounded-full border-2 transition-all ${isActive ? "bg-[#111] border-[#111]" : "bg-white border-[#ECE6DF]"} ${isCurrent ? "ring-2 ring-[#111] ring-offset-2" : ""}`}></div>
                  <div className="ml-4">
                    <p className={`font-semibold ${isActive ? "text-[#111]" : "text-[#8F8881]"}`}>{lang==="zh"?step.label_zh:step.label_en}</p>
